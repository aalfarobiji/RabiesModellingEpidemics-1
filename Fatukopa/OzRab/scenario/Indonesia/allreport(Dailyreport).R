...
base_path <- "G:/WUR/Thesis/Data/Model with HH/Ratio1=8/Fatukopa/OzRab/results/default_results"
...
print(combined_data)
writexl::write_xlsx(combined_data, "G:/WUR/Thesis/Data/Model with HH/Ratio1=8/Fatukopa/OzRab/scenario/Indonesia/allreport(dailyNumberReport)_Fatukopa167.xlsx")
