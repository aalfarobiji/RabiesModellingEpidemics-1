...
base_path <- "G:/WUR/Thesis/Data/Model with HH/Fatukopa/OzRab/results/default_results"
...
write_xlsx(combined_df, "G:/WUR/Thesis/Data/Model with HH/Fatukopa/OzRab/scenario/Indonesia/allreport(dailyNumberReport)_Fatukopa(End).xlsx")
