...
setwd("G:/WUR/Thesis/Data/Model with HH/Ratio1=8/Toianas (NV)/OzRab")
...
OzRab(OzRabArguments(
 ...
 seed = i,                                       # Seed for random number generator. Any integer number different from zero (0)
 ...
 max_time = 2000,                                # number of days the model will not exceed for this outbreak
 scenarioDataPath = "Indonesia",                 # name of the subfolder in the folder scenario
 results_folder =  "default_results",            # name of the results folder 
 nb_index_dogs = 1,                              # number of index dogs
 index_region = "Timor Tengah Selatan",          # index region: HAS to be defined unless more detailed information are given via index_comm, index_hh or index_dog
 index_community = c("Toianas"),                 # index community(ies): can be defined
